...
import myplayground.example.learningq.ui.screens.parent.quiz.ParentStudentQuizCardSkeletonView
import myplayground.example.learningq.ui.theme.LearningQTheme
import myplayground.example.learningq.ui.utils.ViewModelFactory

@Composable
fun ParentStudentPresenceScreen(
    modifier: Modifier = Modifier,
    vm: ParentStudentPresenceViewModel = viewModel(
    ...
    ParentStudentPresenceContent(
        modifier = modifier,
        classesPagingItem = classesPagingItem
    ) { classId ->
        navController.navigate(Screen.ParentPresenceDetail.createRoute(classId))
    }
}

@Composable
fun ParentStudentPresenceContent(
    modifier: Modifier = Modifier,
...
@Composable
fun ParentStudentPresenceContentPreview() {
    LearningQTheme {
        ParentStudentPresenceContent()
    }
}
...
@Preview(showBackground = true, device = Devices.PIXEL_4, uiMode = UI_MODE_NIGHT_YES)
@Composable
fun ParentStudentPresenceCardPreview() {
    LearningQTheme {
        ParentStudentPresenceCard(
            `class` = Class(
                id = "1",
